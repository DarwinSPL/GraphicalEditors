...
public class BlockContextViewHandlePart extends AbstractLogoHoverHandlePart<HoverOverlayImageView> {

	public static final String IMG_DELETE = "/advancedsettings.png";
	public static final String IMG_DELETE_DISABLED = "/advancedsettings.png";

	@Override
	protected HoverOverlayImageView doCreateVisual() {
		URL overlayImageResource = BlockContextViewHandlePart.class.getResource(IMG_DELETE);
		...
		URL baseImageResource = BlockContextViewHandlePart.class.getResource(IMG_DELETE_DISABLED);
